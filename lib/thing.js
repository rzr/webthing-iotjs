...
(id, title, type, description) {
  ...
  this.asThingDescription = function () {
    ...
    for (var name in _this.availableActions) {
    ...
    for (var _name in _this.availableEvents) {
  ...
  this.setHrefPrefix = function (prefix) {
    ...
    for (var actionName in _this.actions) {
      for (var action in _this.actions[actionName]) {
  ...
  this.getPropertyDescriptions = function () {
    ...
    for (var name in _this.properties) {
  ...
  this.propertyNotify = function (property) {
    ...
    for (var subscriber in _this.subscribers) {
